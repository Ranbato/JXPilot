...
void CSplashWnd::OnPaint()
{
    ...
    COLORREF ocolor;
    int omode;
    font.CreateFont(-20, 0, 0, 0,	// No rotation
		    FW_SEMIBOLD, TRUE, FALSE, FALSE,	// No Italic, Underline or Strikeout
		    DEFAULT_CHARSET,
		    OUT_DEFAULT_PRECIS,
		    CLIP_DEFAULT_PRECIS,
...
void CSplashWnd::ShowMessage(const CString & cs)
{
    ...
    font.CreateFont(-20, 0, 0, 0,	// No rotation
		    FW_NORMAL, FALSE, FALSE, FALSE,	// No Italic, Underline or Strikeout
		    DEFAULT_CHARSET,
		    OUT_DEFAULT_PRECIS,
		    CLIP_DEFAULT_PRECIS,
		    DEFAULT_QUALITY, FF_ROMAN | FF_DONTCARE, "");
