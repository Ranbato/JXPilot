...
static bool Set_geometry(xp_option *opt, String value)
{
    UNUSED_PARAM(opt);
    XFREE(geometry);
...
static String Get_geometry(xp_option *opt)
{
...
static bool Set_texturedObjects(xp_option *opt, bool val);

static bool Set_fullColor(xp_option *opt, bool val)
{
    UNUSED_PARAM(opt);
...
static bool Set_mouseAccelNum(xp_option *opt, int value)
{
    UNUSED_PARAM(opt);
...
static bool Set_mouseAccelDenom(xp_option *opt, int value)
{
    UNUSED_PARAM(opt);
...
static bool Set_mouseAccelThresh(xp_option *opt, int value)
{
    UNUSED_PARAM(opt);
...
static bool Set_fontName(xp_option *opt, String val)
{
