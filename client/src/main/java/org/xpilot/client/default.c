...
static String Get_nickName(xp_option *opt)
{
    UNUSED_PARAM(opt);
    return connectParam.nick_name;
}

static String Get_userName(xp_option *opt)
{
    UNUSED_PARAM(opt);
    return connectParam.user_name;
}

static String Get_hostName(xp_option *opt)
{
    UNUSED_PARAM(opt);
...
static String Get_texturePath(xp_option *opt)
{
    UNUSED_PARAM(opt);
    return texturePath;
}
...
static String Get_shipShape(xp_option *opt)
{
    UNUSED_PARAM(opt);
...
static String Get_shipShapeFile(xp_option *opt)
{
    UNUSED_PARAM(opt);
...
static String Get_protocolVersion(xp_option *opt)
{
