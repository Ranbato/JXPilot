...
static void Paint_objects_radar()
{
...
static void Paint_world_radar_old()
{
...
static void Paint_world_radar_new()
{
    int i, j, xoff, yoff;
    Point  min, max;
...
static bool Set_wallRadarColor(xp_option *opt, int value)
{
    UNUSED_PARAM(opt);
...
static bool Set_decorRadarColor(xp_option *opt, int value)
{
    UNUSED_PARAM(opt);
...
static bool Set_targetRadarColor(xp_option *opt, int value)
{
    UNUSED_PARAM(opt);
...
static xp_option paintradar_options[] = {
