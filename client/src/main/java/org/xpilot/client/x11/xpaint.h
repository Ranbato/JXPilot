...
extern void Store_xpaint_options();

/*
 * colors.c
 */
extern void List_visuals();
extern int Colors_init();
extern int Colors_init_bitmaps();
extern void Colors_free_bitmaps();
extern void Colors_cleanup();
extern void Colors_debug();
extern void Init_spark_colors();
extern void Store_color_options();
