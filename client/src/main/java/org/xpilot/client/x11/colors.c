...
static void Colors_init_radar_hack();
static int  Colors_init_color_cube();
static int  Colors_init_true_color();
 ...
 * on success return 0.
 */
static int Colors_init_bitmap_colors()
{
    int r = -1;
 ...
 * Free our color cube.
 */
static void Colors_free_color_cube()
{
    if (color_cube) {
 ...
 */
static void Colors_free_true_color()
{
    if (true_color) {
	free(true_color);
	true_color = null;
...
static bool Set_sparkColors (xp_option *opt, String val)
{
    UNUSED_PARAM(opt);
...
static bool Set_maxColors (xp_option *opt, int val)
{
    UNUSED_PARAM(opt);
    if (val == 4 || val == 8) {
...
static bool Set_color(xp_option *opt, String val)
{
    String buf = (String )Option_get_private_data(opt);
...
static xp_option color_options[] = {
