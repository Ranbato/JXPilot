 ...
 * xdefault.c
 */
extern void Store_X_options();
extern void Handle_X_options();
...
extern void Expose_about_window();
extern void Scale_dashes();
#ifdef _WINDOWS
extern int Credits_callback(int, void *, String *);
#endif
