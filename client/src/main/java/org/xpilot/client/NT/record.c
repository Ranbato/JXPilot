...
static bool setRecordFile(xp_option *opt, String value)
{
    UNUSED_PARAM(opt);
...
static String getRecordFile(xp_option *opt)
{
    UNUSED_PARAM(opt);
    return record_filename;
}

xp_option record_options[] = {
