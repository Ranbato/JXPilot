...
static void Paint_transporters()
{
    int	    i, x_0, y_0, x_1, y_1;
...
static void Paint_all_connectors()
{
...
int Init_wreckage()
{
	...
	for ( i = 0; i < NUM_WRECKAGE_POINTS; i++ ) {
	    wreckageShapes[shp][i] = (Point2D *) dynmem;
	    dynmem += point_size;
